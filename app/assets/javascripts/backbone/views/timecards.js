$(function () {
  ...
  window.Ghostwriter.Models.Timecards = Backbone.Collection.extend({
    db : {
      view : "timecards",
      changes : false
    },
    url : "/timecards",
    model: window.Ghostwriter.Models.Timecard
  });

  window.Ghostwriter.Views.TimecardsView = Backbone.View.extend({
    initialize: function(){
      _.bindAll(this);
      ...
      this.timecardView = new window.Ghostwriter.Views.TimecardView();
    },
    test: function(data){
      console.info(data);
    },
    ...
    select: function(startDate, endDate) {
      ...
      this.timecardView.model = new window.Ghostwriter.Models.Timecard({
        start: startDate,
        end: endDate
      });
