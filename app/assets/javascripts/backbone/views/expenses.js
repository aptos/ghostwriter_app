$(function () {
  ...
  window.Ghostwriter.Models.Expenses = Backbone.Collection.extend({
    db : {
      view : "expenses",
      changes : false
    },
    url : "/expenses",
    model: window.Ghostwriter.Models.Expense
  });

  window.Ghostwriter.Views.ExpensesView = Backbone.View.extend({
    ...
    initialize: function(){
      ...
      this.expenseView = new window.Ghostwriter.Views.ExpenseView();
    },
    events: {
    ...
    newExpense:function (event) {
      ...
      var expenseView = new window.Ghostwriter.Views.ExpenseView();
      expenseView.collection = this.collection;
      expenseView.model = new window.Ghostwriter.Models.Expense();
